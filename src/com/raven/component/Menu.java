...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("2", "Hour Tracking", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "Explore", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4", "Forms", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5", "Calendar", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("10", "Log Out", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/raven/icon/logo_search.png"))); // NOI18N
        jLabel1.setText("Service Tracker");
