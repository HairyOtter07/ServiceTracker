...
public class Form_1 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        card1.setData(new Model_Card(new ImageIcon(getClass().getResource("/com/raven/icon/stock.png")),
                "Hour Goal: 100", "1/01/2024", "PVSA Award"));
        card1.setBounds(700, -150, 400, 400);
        panel.setSize(1000, 1000);
        card2.setLocation(700, -150);
            ...
            public void mouseClicked(MouseEvent e) {
                if (eventTextField.getText().length() != 0) {
                    if (locationTextField.getText().length() != 0) {
                        if ((hoursTextField.getText().length() == 1 || hoursTextField.getText().length() == 2
                                || hoursTextField.getText().length() == 3)
                                && (hoursTextField.getText().matches("\\d+"))) {
                            if (dateTextField.getText().matches("^\\d{1,2}/\\d{1,2}/\\d{4}$")) {
                                ...
                                JOptionPane.showMessageDialog(null,
                                        "You need to fill out the Date field correctly (mm/dd/yyyy).");
                            }
                        } else {
                            JOptionPane.showMessageDialog(null,
                                    "You need to put a valid number of hours into the Hours Logged field.");
                        }
                    } else {
